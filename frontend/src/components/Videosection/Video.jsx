...
const Video = () => {
  return (
    <>
        ...
        <div className="section class bg-dark has-bg-image" id='class' style={{backgroundImage: `url(${dark_img})`}}>
                    ...
                    <div className="class-card">
                        ...
                        <div className="class-content">
                            <div className="title-wrapper">
                                <img src={weight_lifting} alt="" style={{width: "52px", height:"52px"}} className='title-icon' />
                            </div>

                            <h3 className='h3'>Weight Lifting</h3>

                            <p className="card-text">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, fuga perferendis.
                            </p>
